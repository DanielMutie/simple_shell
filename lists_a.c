...
/**
 * add_node_begining - This adds a node to the start of the list
 * @head: This is the address of pointer to head node
 * @str: The str field of node
 * @num: The node index used by history
 * Return: size of list
 */
list_t *add_node_begining(list_t **head, const char *str, int num)
{
    list_t *new_head;
 ...
 * @head_ptr:This the address of pointer to head node
 * Return: void
 */

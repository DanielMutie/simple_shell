...
/**
 * list_length - This determines length of linked list
...
/**
 * list_of_strings - This returns an array of strings of the list->str
...
/**
 * print_lists - This prints all elements of a list_t linked list
...
/**
 * start_node_is - This returns node whose string starts with prefix
 ...
 */
list_t *start_node_is(list_t *node, char *prefix, char c)
{
    char *p = NULL;
